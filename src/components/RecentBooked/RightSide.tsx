        ...
        <div className="space-y-4">
          {filteredBookings.map((booking, index) => (
            <div
              ...
              className="flex items-center justify-between bg-white p-4 rounded-xl shadow-md cursor-pointer"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-lg text-[var(--navy)]">{booking.id}</p>
                  ...
                  <div className="flex gap-2 mt-1 text-xs text-gray-500">
                    ...
                    <div
                      className={`px-3 py-2 rounded-full text-md font-medium ${statusColor[booking.status]}`}
                    >
                      {booking.status}
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-3">
                {booking.status === "Completed" ? (
                  <div
                    className="w-14 h-14 flex items-center justify-center bg-[#F2A307] rounded-full"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  <div
                    className="w-14 h-14 flex items-center justify-center bg-[#FF5C5F] rounded-full"
                    onClick={(e) => {
                      e.stopPropagation();
                      setOpenDialog(true);
                    }}
