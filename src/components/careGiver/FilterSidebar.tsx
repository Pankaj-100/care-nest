    ...
    <aside className="w-full md:w-[250px] border rounded-xl p-4 space-y-4">
      ...
      <div>
        ...
        {["Within 2 miles", "Within 10 miles", "Within 15 miles", "Within 20 miles", "Within 30 miles"].map((loc, idx) => (
          <label key={idx} className="block text-sm font-medium text-[#98A2B3]">
            <input type="checkbox" className="mr-2" />
            {loc}
          </label>
        ))}
      ...
      <div>
        ...
        <label className="text-sm text-[#98A2B3] font-medium"><input type="checkbox" className="mr-2" /> As Needed</label><br />
        <label className="text-sm text-[#98A2B3]font-medium"><input type="checkbox" className="mr-2" /> Fixed Schedule</label>
      </div>
      ...
      <div>
        ...
        <label className="text-sm text-[#98A2B3] font-medium"><input type="checkbox" className="mr-2" /> Yes</label><br />
        <label className="text-sm text-[#98A2B3] font-medium"><input type="checkbox" className="mr-2" /> No</label>
      </div>
      ...
      <div>
        ...
        {["English", "Spanish", "French", "German", "Russian", "Japanese"].map((lang, idx) => (
          <label key={idx} className="block text-[#98A2B3] font-medium">
            <input type="checkbox" className="mr-2" />
            {lang}
          </label>
        ))}
