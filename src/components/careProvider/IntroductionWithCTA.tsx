...
const IntroductionWithCTA = () => {
  return (
    <div className="flex lg:flex-row  justify-around flex-col gap-y-10  relative bg-[var(--whiteSmoke)] lg:h-[475px] h-max lg:p-16 p-8  ">
      <div className=" text-white lg:w-1/2">
        <div>
          <h1 className="font-semibold text-5xl leading-16 text-[var(--navy)] ">
            Looking to Provide Care For <br />The Elderly?
          </h1>
        </div>
      ...
      <div className="relative w-auto h-90 lg:w-1/3 lg:h-2/3">
