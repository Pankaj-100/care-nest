    ...
    return (
        <div className='py-20 bg-[var(--whiteSmoke)] px-28'>
            ...
            <div className='text-center flex items-center justify-center mb-10'>
                <h1 className='font-bold text-5xl text-center w-2/3'>Resources are essential for human activities in various realms.</h1>
            </div>

            <div className='flex itemcenter justify-around'>
                <BlogCard />
                <BlogCard />
                <BlogCard />
            </div>
    ...
    return (
        <div className='p-2 w-70'>
            ...
            <div>
                ...
                <h3 className='font-semibold text-lg my-2 text-[var(--navy)]'>Elderly Care at Home: How to Ensure Comfort & Safety</h3>
                <p className='text-sm text-[var(--navy)] mb-3'>What the data says about the harm of unnecessary medical tests</p>
            </div>
