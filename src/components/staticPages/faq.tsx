...
return (
	<div className="min-h-screen bg-white flex flex-col mt-15 items-center">
		...
		<div className="w-full max-w-6xl flex flex-col md:grid md:grid-cols-2 gap-8 items-center md:items-start px-4">
			...
			<h2 className="text-[var(--navy)] font-semibold text-2xl sm:text-2xl lg:text-4xl mb-4 sm:mb-6 text-center md:text-left max-w-xl md:max-w-none mx-auto md:mx-0">
